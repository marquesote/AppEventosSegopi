...
export const metadata: Metadata = {
  ...
  description: `Términos de servicio de ${siteConfig.companyName}.`,
}
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-8 text-foreground-secondary text-body-md leading-relaxed">
            <div>
              ...
              <p>
                Al acceder y utilizar el sitio web de {siteConfig.companyName}, usted acepta estar sujeto a estos términos de servicio. Si no está de acuerdo con alguna parte de estos términos, no debe utilizar nuestro sitio web.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Todo el contenido de este sitio web, incluyendo textos, gráficos, logotipos e imágenes, es propiedad de {siteConfig.companyName} y está protegido por las leyes de propiedad intelectual de {siteConfig.contact.country}.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                {siteConfig.companyName} no será responsable de daños directos, indirectos, incidentales o consecuentes que resulten del uso de este sitio web. Los resultados de casos anteriores no garantizan resultados futuros similares.
              </p>
            </div>
