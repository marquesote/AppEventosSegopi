        ...
        <div className="prose prose-lg text-foreground-secondary space-y-6">
          <section>
            ...
            <p>
              ...
              (ordenador, tablet o movil) cuando los visita. Se utilizan para hacer que los sitios web
              funcionen de manera mas eficiente y proporcionar informacion a los propietarios del sitio.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              recopilando informacion de forma anonima. Actualmente no utilizamos cookies
          ...
          <section>
            <h2 className="text-display-xs text-foreground">Actualizaciones de esta politica</h2>
            <p>
